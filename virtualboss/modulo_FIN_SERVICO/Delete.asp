...
<% VerificaDireito "|DEL|", BuscaDireitosFromDB("modulo_FIN_SERVICO", Request.Cookies("VBOSS")("ID_USUARIO")), true %>
 ...
 Const auxAVISO  = "dlg_warning.gif:ATENÇÃO!Você está prestes a remover o registro <br> acima visualizado. Para confirmar clique no botão [ok], para desistir clique em [cancelar]."
   ...
   strCODIGO = GetParam("var_chavereg")
	...
	if strCODIGO <> "" then 
		...
		strSQL = " SELECT TITULO, DESCRICAO, OBS, VALOR FROM SV_SERVICO WHERE COD_SERVICO=" & strCODIGO
...
<body>
<%=athBeginDialog(WMD_WIDTH, "Servi&ccedil;os - Dele&ccedil;&atilde;o")%>
