...
function mitem_init() 
{
 ...
 //Sem imagem pois estava gerando erro na montagem do menu
 //21/07/2006 - Clv
 //
 //if (this.depth==0)	
 // { imgmenu='<img src="../img/IcoMenu03.gif" border="0" hspace="6">';}
 //else
 // { imgmenu='<img src="../img/BulletMenuDown.gif" border="0" hspace="6">'; }

 document.write(
		'<a id="mi_' + this.container.id + '_'
			+ this.id +'" class="m' + this.container.id + 'l' + this.depth 
			+'o" target="vbfr_pcenter" href="' + this.fields[1] + '" style="position: absolute; top: '
			...
			+ this.id + ');"><div id="menudivs" class="m'  + this.container.id + 'l' + this.depth + 'i">' + imgmenu
			+ margem + this.fields[0] + "</div></a>\n");
...
x.insertRule(".m0l"+noofcommascount+"o {text-decoration : none; border : 0px solid #ffffff}",x.cssRules.length);
x.insertRule(".m0l"+noofcommascount+"i {"+fontstyles+"}",x.cssRules.length);
}
else
{
 document.styleSheets[0].addRule(".m0l"+noofcommascount+"o", "text-decoration : none; border : 0px solid #ffffff;")
