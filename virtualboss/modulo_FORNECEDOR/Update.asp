...
<% VerificaDireito "|UPD|", BuscaDireitosFromDB("modulo_FORNECEDOR", Request.Cookies("VBOSS")("ID_USUARIO")), true %>
...
<%
 ...
 Const auxAVISO  = "<span class='texto_ajuda'>Campos com * são obrigatórios.</span>"
	...
	If strCODIGO <> "" Then
		...
		strSQL = strSQL & "      ,T1.DT_INATIVO, T1.FATURA_ENDERECO, T1.FATURA_NUMERO, T1.FATURA_COMPLEMENTO"
		strSQL = strSQL & "      ,T1.FATURA_CEP, T1.FATURA_BAIRRO, T1.FATURA_CIDADE, T1.FATURA_ESTADO, T1.FATURA_PAIS,T1.CONTATO " 
...
<body>
<%=athBeginDialog(WMD_WIDTH, "Fornecedor - Alteração")%>
<form name="form_update" action="../_database/athUpdateToDB.asp" method="post">
	...
	<input type="hidden" name="DEFAULT_LOCATION" value="../modulo_FORNECEDOR/update.asp?var_chavereg=<%=strCODIGO%>">
	...
	<div class="form_grupo" id="form_grupo_1">
		...
		<br><br><div class="form_label">Endere&ccedil;o:</div><input name="DBVAR_STR_FATURA_ENDERECO" type="text" style="width:300px" value="<%=GetValue(objRS,"FATURA_ENDERECO")%>">
		<br><div class="form_label">N&uacute;mero:</div><input name="DBVAR_STR_FATURA_NUMERO" type="text" style="width:50px" maxlength="20" value="<%=GetValue(objRS,"FATURA_NUMERO")%>">&nbsp;Complemento&nbsp;<input name="DBVAR_STR_FATURA_COMPLEMENTO" type="text" style="width:50px" maxlength="40" value="<%=GetValue(objRS,"FATURA_COMPLEMENTO")%>">
		...
		<br><div class="form_label">Pa&iacute;s:</div><input type="text" name="DBVAR_STR_FATURA_PAIS" value="<%=GetValue(objRS,"FATURA_PAIS")%>" style="width:150px">
	</div>
	...
	<div class="form_grupo_collapse" id="form_grupo_2">
		...
		<br><div class="form_label">N&uacute;mero:</div><input name="DBVAR_STR_COBR_NUMERO" type="text" style="width:50px" maxlength="20" value="<%=GetValue(objRS,"COBR_NUMERO")%>">&nbsp;Complemento&nbsp;
      <input name="DBVAR_STR_COBR_COMPLEMENTO" type="text" style="width:50px" maxlength="40" value="<%=GetValue(objRS,"COBR_COMPLEMENTO")%>">
	...
	<div class="form_grupo_collapse" id="form_grupo_3">
		...
		<br><div class="form_label">N&uacute;mero:</div><input name="DBVAR_STR_ENTR_NUMERO" type="text" style="width:50px" maxlength="20" value="<%=GetValue(objRS,"ENTR_NUMERO")%>">&nbsp;Complemento&nbsp;<input name="DBVAR_STR_ENTR_COMPLEMENTO" type="text" style="width:50px" maxlength="40" value="<%=GetValue(objRS,"ENTR_COMPLEMENTO")%>">
