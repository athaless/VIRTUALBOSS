...
<% VerificaDireito "|INS|", BuscaDireitosFromDB("modulo_FORNECEDOR", Request.Cookies("VBOSS")("ID_USUARIO")), true %>
...
<body>
<%=athBeginDialog(WMD_WIDTH, "Fornecedor - Inserção") %>
<form name="form_insert" action="../_database/athInsertToDB.asp" method="post">
	<input type="hidden" name="DEFAULT_TABLE" value="ENT_FORNECEDOR">
	<input type="hidden" name="DEFAULT_DB" value="<%=CFG_DB%>">
	<input type="hidden" name="FIELD_PREFIX" value="DBVAR_">
	<input type="hidden" name="RECORD_KEY_NAME" value="COD_FORNECEDOR">
	<input type="hidden" name="DBVAR_DATE_DT_CADASTRO" value="<%=Date()%>">
	<input type="hidden" name="JSCRIPT_ACTION"   	value='parent.frames["vbTopFrame"].document.form_principal.submit();'>
	<input type="hidden" name="DEFAULT_LOCATION" 	value='../modulo_FORNECEDOR/insert.asp'>
    ...
    <br><div class="form_label">N&uacute;m. Documento:</div><select name="DBVAR_STR_TIPO_DOC"  style="width:80px">
													        ...
													        </select><input name="DBVAR_STR_NUM_DOC" type="text" 
															          style="width:120px">
    <br><div class="form_label">Inscri&ccedil;&atilde;o Estadual:</div><input name="DBVAR_STR_INSC_ESTADUAL" type="text" 
																		 style="width:120px">
    <br><div class="form_label">Inscri&ccedil;&atilde;o Municipal:</div><input name="DBVAR_STR_INSC_MUNICIPAL" type="text" 
																		 style="width:120px">
    <br><div class="form_label">Fone:</div><input name="DBVAR_STR_FONE_1" type="text" style="width:100px">
	...
	<div class="form_grupo_collapse" id="form_grupo_4">
		...
		<div style="padding-left:110px;"><span class="texto_ajuda"><i>Marque a opção e informe o percentual se fornecedor possui uma<br>alíquota específica de IRPJ.</i></span></div>
	</div>	
	...
	<div class="form_grupo" id="form_grupo_1">
		...
		<br><br><div class="form_label">Endere&ccedil;o:</div><input name="DBVAR_STR_FATURA_ENDERECO" type="text" style="width:300px">
		<br><div class="form_label">N&uacute;mero:</div><input name="DBVAR_STR_FATURA_NUMERO" type="text" style="width:50px" maxlength="20">&nbsp;Complemento&nbsp;<input name="DBVAR_STR_FATURA_COMPLEMENTO" type="text" style="width:50px" maxlength="40">
    ...
    <div class="form_grupo_collapse" id="form_grupo_2">
		...
		<img src="../img/BulletMais.gif" id="form_collapse_2" border="0" onClick="ShowArea('form_grupo_2','form_collapse_2');" 
  		style="cursor:pointer;">
		<b>Endereço de Cobran&ccedil;a</b>&nbsp;<a style="cursor:hand" onClick="CopiaDados('form_insert','COBR');">(Copiar Dados)</a></b>
		<br><br><div class="form_label">Endere&ccedil;o:</div><input name="DBVAR_STR_COBR_ENDERECO" type="text" style="width:300px">
		<br><div class="form_label">N&uacute;mero:</div><input name="DBVAR_STR_COBR_NUMERO" type="text" style="width:50px" maxlength="20">&nbsp;Complemento&nbsp;<input name="DBVAR_STR_COBR_COMPLEMENTO" type="text" style="width:50px" maxlength="40">
	...
	<div class="form_grupo_collapse" id="form_grupo_1">
		...
		<br><div class="form_label">N&uacute;mero:</div><input name="DBVAR_STR_ENTR_NUMERO" type="text" style="width:50px" maxlength="20">&nbsp;Complemento&nbsp;<input name="DBVAR_STR_ENTR_COMPLEMENTO" type="text" style="width:50px" maxlength="40">
		<div class="form_label">CEP:</div><input name="DBVAR_STR_ENTR_CEP" type="text" style="width:90px">
		<div class="form_label">Bairro:</div><input name="DBVAR_STR_ENTR_BAIRRO" type="text" style="width:150px">
		<div class="form_label">Cidade:</div><input name="DBVAR_STR_ENTR_CIDADE" type="text" style="width:200px">
		<div class="form_label">Estado:</div><select name="DBVAR_STR_ENTR_ESTADO" style="width:200px">
										          <option value="">Selecione...</option>
          <%
	      arrESTADOS = array("AC","AL","AP", "AM", "BA", "CE", "DF", "ES", "GO", "MA", "MT", "MS", "MG", "PA", "PB", "PR", "PE", "PI", "RJ", "RN", "RS", "RO", "RR", "SC", "SP", "SE", "TO")
	      arrNOMES = array("Acre","Alagoas","Amapá", "Amazonas", "Bahia", "Ceará", "Distrito Federal", "Espírito Santo", "Goias", "Maranhão", "Mato Grosso", "Mato Grosso do Sul", "Minas Gerais", "Pará", "Paraíba", "Paraná", "Pernambuco", "Piauí", "Rio de Janeiro", "Rio Grande do Norte", "Rio Grande do Sul", "Rondônia", "Roraima", "Santa Catarina", "São Paulo", "Sergipe", "Tocantins")
