...
<% VerificaDireito "|DEL|", BuscaDireitosFromDB("modulo_TODOLIST", Request.Cookies("VBOSS")("ID_USUARIO")), true %>
...
' -------------------------------------------------------------------------------
    ...
    If GetParam("var_chavereg") <> "" Then
	  ...
	  strSQL = "SELECT * FROM TL_TODOLIST WHERE COD_TODOLIST = " & GetParam("var_chavereg") 
...
<body>
<%=athBeginDialog(WMD_WIDTH, "Tarefa - Dele&ccedil;&atilde;o")%>     
...
<form name="form_delete" action="../_database/athDeleteToDB.asp" method="post">
	<input type="hidden" name="DEFAULT_TABLE"    value="TL_TODOLIST">
    <input type="hidden" name="DEFAULT_DB"       value="<%=CFG_DB%>">
    <input type="hidden" name="FIELD_PREFIX"     value="DBVAR_">
    <input type="hidden" name="RECORD_KEY_NAME"  value="COD_TODOLIST">
