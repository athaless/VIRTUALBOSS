...
<%
 ...
 Dim strPREVeREAL, strCCUSTO, strPLANOCONTA
 ...
 if strANO<>"" then
	...
	AbreRecordSet objRS, strSQL, objConn, adLockOptimistic, adOpenDynamic, adUseClient, -1
 	...
 	Do While Not objRS.Eof
		...
		'matRS(CONTA_PREVeREL,i)   = GetValue(objRS, "CONTA_PREVISTA") & "/" & GetValue(objRS, "CONTA_REALIZADA")
		matRS(CONTA_PREVeREL,i)   = GetValue(objRS, "CONTA_REALIZADA")
		...
		matRS(NOME_CCUSTO,i)        = GetValue(objRS, "NOME_CENTRO_CUSTO")
...
<table align="center" cellpadding="0" cellspacing="1" style="width:100%" class="tablesort">
 <thead>
  <tr> 
    ...
    <th WIDTH="5%" nowrap>Conta</th>
    <th WIDTH="25%" nowrap>C.Custo</th>								
    <th WIDTH="20%">P.Conta</th>								
...
<%	
	    ...
	    strMES = month(matRS(DATA,i))
  		while i < intTamNew
			...
			strPREVeREAL = matRS(CONTA_PREVeREL,i)
			strCCUSTO	 = matRS(NOME_CCUSTO,i)
