...
<form name="form_insert" action="Renova_exec.asp" method="post">
	...
	<%
	  'Busca serviços do contrato anterior
	...
	%>        
	<br><div class="form_label">Alíquota ISSQN:</div><input name="var_aliq_issqn" type="text" value="<%=GetValue(objRS, "ALIQ_ISSQN_SERVICO")%>" maxlength="10" style="width:70px" onKeyPress="validateFloatKey();">
	...
	<div class="form_grupo" id="form_grupo_1">
		...
		<br><div class="form_label">*Dt Vcto 1ª Parcela:</div><input name="var_dt_base_vcto" value="" type="text" maxlength="10" style="width:70px;" onKeyPress="Javascript:validateNumKey();" onKeyUp="Javascript:FormataInputData(this.form.name, this.name); " onBlur="Javascript:addInputsParcela(document.getElementsByName('var_num_parcela_ref')[0].value);">&nbsp;<%=ShowLinkCalendario("form_insert", "var_dt_base_vcto", "ver calendário")%>&nbsp;<span class="texto_ajuda">dd/mm/aaaa</span>
