...
'athDebug strNOME   & "<br>", false
'athDebug strCODIGO & "<br>", false
'athDebug strTIPO   & "<br>", false

'athDebug strFORM &"." & strINPUT1 & ".value=" & "<br>", false
'athDebug strFORM &"." & strINPUT2 & ".value=" & "<br>", true
