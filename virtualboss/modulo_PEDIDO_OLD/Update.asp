...
<% VerificaDireito "|UPD|", BuscaDireitosFromDB("modulo_PEDIDO_OLD", Request.Cookies("VBOSS")("ID_USUARIO")), true %>
...
<form name="form_update" action="../_database/athUpdateToDB.asp" method="post">
	...
	<input type="hidden" name="DEFAULT_LOCATION" value="../modulo_PEDIDO_OLD/Update.asp?var_chavereg=<%=strCODIGO%>">
