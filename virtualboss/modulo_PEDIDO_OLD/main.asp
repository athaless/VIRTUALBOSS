...
Response.Expires = -1
VerificaDireito "|VIEW|", BuscaDireitosFromDB("modulo_PEDIDO_OLD", Request.Cookies("VBOSS")("ID_USUARIO")), true %>
	...
	While Not objRs.Eof
		...
		<tr bgcolor="<%=strColor%>">
			...
			If GetValue(objRS,"SITUACAO") = "ABERTO" Then
				Response.Write(MontaLinkGrade("modulo_PEDIDO_OLD","Delete.asp",GetValue(objRS,"COD_NF"),"IconAction_DEL.gif","REMOVER"))
			End If
			%></td>
			<td><%=MontaLinkGrade("modulo_PEDIDO_OLD","Update.asp",GetValue(objRS,"COD_NF"),"IconAction_EDIT.gif","ALTERAR")%></td>
			<td><%=MontaLinkGrade("modulo_PEDIDO_OLD","Detail.asp",GetValue(objRS,"COD_NF"),"IconAction_DETAILadd.gif","INSERIR ITEM")%></td>
			<td><%
			If GetValue(objRS,"SITUACAO") = "ABERTO" Then
				Response.Write(MontaLinkGrade("modulo_PEDIDO_OLD","Fatura.asp",GetValue(objRS,"COD_NF"),"IconAction_GERACP.gif","FATURAR"))
			End If
			%></td>
