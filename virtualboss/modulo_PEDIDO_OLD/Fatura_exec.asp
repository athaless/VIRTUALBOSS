...
<%
	...
	If Err.Number <> 0 Then
		...
		Mensagem "modulo_PEDIDO_OLD.Fatura_Exec A: " & Err.Number & " - "& Err.Description , DEFAULT_LOCATION, 1, True
		Response.End()
	else
	...
	Else
		...
		If Err.Number <> 0 Then
			set objRSCT = objConn.Execute("rollback")
			Mensagem "modulo_PEDIDO_OLD.Fatura_Exec B: " & Err.Number & " - "& Err.Description , DEFAULT_LOCATION, 1, True
			Response.End()
		else
			set objRSCT = objConn.Execute("commit")
		End If
