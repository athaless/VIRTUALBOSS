...
<% VerificaDireito "|DEL|", BuscaDireitosFromDB("modulo_MENU", Request.Cookies("VBOSS")("ID_USUARIO")), true %>
...
<%
   ...
   If strCODIGO <> "" Then
	  ...
	  strSQL = "SELECT * FROM SYS_MENU WHERE COD_MENU = " & strCODIGO
...
<body>
<%=athBeginDialog(WMD_WIDTH, "Account Service - Dele&ccedil;&atilde;o")%>     
...
<form name="form_delete" action="../_database/athDeleteToDB.asp" method="post">
	<input type="hidden" name="DEFAULT_TABLE"    value="SYS_MENU">
    <input type="hidden" name="DEFAULT_DB"       value="<%=CFG_DB%>">
    <input type="hidden" name="FIELD_PREFIX"     value="DBVAR_">
    <input type="hidden" name="RECORD_KEY_NAME"  value="COD_MENU">
