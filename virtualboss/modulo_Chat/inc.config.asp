<%
	...
	'
	Const ADMINISTRATOR_PASSWORD = "andfor"
	...
	' 
	Const BLOCKED_USERNAMES = "admin, administrador, administrator, sede, central, gerência, gerencia"
