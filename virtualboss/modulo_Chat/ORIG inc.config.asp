<%
	...
	'
	Const APPLICATION_NAME = "Redeconn: Chat"
	...
	'
	Const WEBMASTER_EMAIL = "webmaster@redeconn.com.br"
	...
	' 
	Const BLOCKED_USERNAMES = "admin, administrador, administrator, redemac, redeconn, sede, central"
