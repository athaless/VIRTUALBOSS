<%
	...
	'
	Const ADMINISTRATOR_PASSWORD = "follond"
	...
	'
	Const APPLICATION_NAME = "Bondmann Química : Chat"
	...
	'
	Const WEBMASTER_EMAIL = "webmaster@athenas.com.br"
	...
	'
	Const DEFAULT_ROOMS = "Geral;Gerência;Paulo;Villela;Emilton;Berwanger;Azevedo;Maurilio;Jefferson;Motta;Claiton;Tesser"
	...
	'
	Const BAD_WORDS_FILTER = "foda, merda, puta, puto, fuder, fude, fudê, putao, putão, cu, cú, pissa, piça, porra, bicha, viado, boiola, buceta"
	...
	' 
	Const BLOCKED_USERNAMES = "admin, administrator, bondmann"
	...
	Const LOGGED_OUT_PAGE = "../arearestrita/ShowOpcao.asp"
