<%
	...
	Sub readMessages()
		Dim messageFile 
		messageFile = Server.MapPath("/web_systems/orcanet/modulo_Chat/messages/messages." & MESSAGE_LANGUAGE)
		
		Dim fs
		Set fs = CreateObject("Scripting.FileSystemObject")

		'Response.Write("messageFile: " & messageFile)
		'Response.Write(fs.FileExists(messageFile))
		'Response.End()
