...
<head>
	...
	<!--
		...
		function sendMessage() {
			...
			if (message == '') {
				executeGetParam('action=refresh');
				return;
			}
			...
			executeGetParam('action=refresh,mode=message,message=' + escape(message) + ',toUserId=' + toUserId);
	...
	<td>
		...
		<tr>
			...
			<td>
				...
				<img src="images/smilies/angry.gif" width=16 height=16 border=0 class=lnk onClick="insertSmiley(':-[')">
			</td>
		</tr>
		</table>
	</td>
