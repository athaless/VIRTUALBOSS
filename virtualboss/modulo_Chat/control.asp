...
<%
	...
	If (GetParam("action") = "refresh") Then
	...
	If (GetParam("action") = "private.refresh") Then
		
		Dim touser
		Set touser = getUser(CStr(GetParam("toUserId")))
	...
	If (GetParam("action") = "update.users") Then
	...
	If (GetParam("action") = "update.rooms") Then
	...
	If (GetParam("action") = "room.switch") Then
