...
'		End If
	...
	Function formatMessageUI(user, message)
		...
		if LastUserThatSaySomething <> user.name then  
		  formatMessageUI = "<div class=message>" & _
          getMsg("user.say_all","<span class=username>"& user.name &"</span>", "<span class=message>" & message & "</span>") & "</div>"
	      LastUserThatSaySomething = user.name
		else
		  formatMessageUI = "<div class=message>" & _
          getMsg("user.say_all","<span class=username></span>", "<span class=message>" & message & "</span>") & "</div>"
		end if
