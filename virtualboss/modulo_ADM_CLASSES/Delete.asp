...
<% VerificaDireito "|DEL|", BuscaDireitosFromDB("modulo_ADM_CLASSES", Request.Cookies("VBOSS")("ID_USUARIO")), true %>
...
' -------------------------------------------------------------------------------
   ...
   If strCODIGO <> "" Then
	  ...
	  strSQL = "SELECT * FROM adm_classe WHERE COD_CLASSE = " & strCODIGO 
...
<body>
<%=athBeginDialog(WMD_WIDTH, "Classes - Dele&ccedil;&atilde;o")%>
