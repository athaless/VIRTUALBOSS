...
if strFORM = "" then strFORM= "form_insert"
			...
			<div style="padding-top:20px;padding-right:3px;"> 
				<table height="30" cellpadding="0" cellspacing="0" border="0">
					...
					<tr>
						...
						<td width="5"></td>
						<td width="50">
							<select name="var_tipo" class="edtext_combo" style="width:180px">
...
<%
      while not objRS.Eof
%>
	<tr bgcolor="#DAEEFA" style="cursor:hand;" onMouseOver="this.style.backgroundColor='#FFCC66';" onMouseOut="this.style.backgroundColor='';" onClick="Retorna('<%=GetValue(objRS,"CODIGO")%>');"> 
