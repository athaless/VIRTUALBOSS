...
Dim strJSCRIPT_ACTION, strLOCATION
	...
	If Err.Number <> 0 Then
		...
		Mensagem "modulo_FIN_TITULOS.UpdateLcto_exec: " & Err.Number & " - "& Err.Description , DEFAULT_LOCATION, 1, True
		Response.End()
	else
