...
<%
Dim objConn, objRS, strSQL, objRSTs
...
If strCOD_CONTA_RECEBER <> "" Then
	...
	if not objRS.eof then
		...
		If Err.Number <> 0 Then
		  ...
		  Mensagem "modulo_FIN_TITULOS.GeraNFdeTitulo A: " & Err.Number & " - "& Err.Description , DEFAULT_LOCATION, 1, True
 		  Response.End()
		else
	...
	If strMSG = "" Then
		...
		If Err.Number <> 0 Then
		  set objRSTs = objConn.Execute("rollback")
		  Mensagem "modulo_FIN_TITULOS.GeraNFdeTitulo B: " & Err.Number & " - "& Err.Description , DEFAULT_LOCATION, 1, True
 		  Response.End()
		else
		  set objRSTs = objConn.Execute("commit")
		End If
		...
		If Err.Number <> 0 Then
		  set objRSTs = objConn.Execute("rollback")
		  Mensagem "modulo_FIN_TITULOS.GeraNFdeTitulo C: " & Err.Number & " - "& Err.Description , DEFAULT_LOCATION, 1, True
 		  Response.End()
		else
		  set objRSTs = objConn.Execute("commit")
		End If
