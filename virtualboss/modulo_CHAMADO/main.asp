...
<%
 ...
 'strENT_CLI_REF     = GetParam("var_ent_ref_cli") PODE receber nesta variavel os códigos dos clientes que o usuário pode ver chamados
...
if (strCLIENTE <> "") then 
  ...
  'Quando mudou na TOP.ASP de um "input" para um "combo", o strCLIENTE passou a vir com o código enão mais a struing pra buscar na razao, nomefan etc...
...
<table align="center" cellpadding="0" cellspacing="1" style="width:100%" class="tablesort">
  ...
  <thead>
	...
	<!-- Retirado de visualização por um tempo, pois parece não ser necessário MAI/2013
      <th class="sortable">Usr</th>
	...
	<% End If %>
      ...
      <td width="16" align="center" valign="top">
        <% strEvalObs = GetValue(objRS,"SYS_EVALUATE_OBS") 
		  ...
		  'Nesta grade aqui [Main.asp] devemos tratar o valor do campo observação para mostar somente a última observação.
