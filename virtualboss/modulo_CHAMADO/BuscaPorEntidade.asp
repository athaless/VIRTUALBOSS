...
<%
	strSQL = " SELECT COD_CLIENTE AS CODIGO, NOME_FANTASIA AS NOME, EMAIL, DT_INATIVO, TIPO_CHAMADO FROM ENT_CLIENTE " 
	If strPALAVRA_CHAVE <> "" Then
		strSQL = strSQL & " WHERE (NOME_FANTASIA LIKE '%" & strPALAVRA_CHAVE & "%' OR "
