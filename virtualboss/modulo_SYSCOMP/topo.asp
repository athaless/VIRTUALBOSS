		...
		<div class="form_line">
	      <form name="form_principal" method="post" action="main.asp" target="vbMainFrame">
	          <select name="var_status" class="edtext_combo" style="width:120px;">
	            ...
	            <option value="3">Não Instalados COMs</option>
	          </select>
	          <select name="var_categ" class="edtext_combo" style="width:150px;">>
	            ...
	            <option value=5>Manipulação de Arquivos</option>
	            <option value=6>Gráficos</option>
	            <option value=7>Gerenciamento de Usuários</option>
	            <option value=8>E-Commerce</option>
	            <option value=9>Formulários</option>
