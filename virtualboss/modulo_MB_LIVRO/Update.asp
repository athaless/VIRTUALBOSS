...
<% VerificaDireito "|UPD|", BuscaDireitosFromDB("modulo_MB_LIVRO", Request.Cookies("VBOSS")("ID_USUARIO")), true %>
...
<%
	...
	if strCODIGO <> "" then 
		strSQL =          " SELECT COD_LIVRO, TITULO, ID, CDU, CDD, AQUISICAO, AUTORES, EDITORA, EDICAO, ANO, ASSUNTO, ISBN, IMG, CODBAR, LOCALIZACAO, RESENHA, PRAZO_EMPR, IDIOMA, COD_CATEGORIA, CLASSE, VOLUME, EXTRA, DT_INATIVO, LOCADO, PROPRIEDADE"
		strSQL = strSQL & " FROM mb_livro "
		strSQL = strSQL & " WHERE COD_LIVRO = " & strCODIGO
	...
	<head>
		...
		<script language="javascript" type="text/javascript">
			...
			function submeterForm() {
				...
				if (document.form_update.DBVAR_STR_AUTORESô.value == '') var_msg += '\n Autores';
...
<body>
<%=athBeginDialog(WMD_WIDTH, "Livro - Altera&ccedil;&atilde;o") %>
<form name="form_update" action="../_database/athUpdateToDB.asp" method="post">
	...
	<input type="hidden" name="DEFAULT_LOCATION" value="../modulo_MB_LIVRO/Update.asp?var_chavereg=<%=strCODIGO%>">
	...
	<div class="form_grupo" id="form_grupo_1">
		...
		<br><div class="form_label">*Autores:</div><textarea name="DBVAR_STR_AUTORESô" style="width:270px;height:50px;"><%=GetValue(objRS,"AUTORES")%></textarea>
		...
		<div class="form_label_nowidth" style="text-align:right;width:40px;">Volume:</div><input name="DBVAR_STR_VOLUME" type="text" style="width:40px;" maxlength="10" value="<%=GetValue(objRS,"VOLUME")%>">
		...
		<br><div class="form_label">Categoria:</div><select name="DBVAR_INT_COD_CATEGORIA" style="width:140px;"><option value="NULL"></option><%=montaCombo("STR","SELECT COD_CATEGORIA, NOME FROM mb_livro_categoria WHERE DT_INATIVO IS NULL","COD_CATEGORIA","NOME",GetValue(objRS,"COD_CATEGORIA"))%></select>
		...
		<br><div class="form_label">Imagem:</div><input name="DBVAR_STR_IMG" type="text" maxlength="250" value="<%=GetValue(objRS,"IMG")%>" style="width:200px;"><a href="javascript:UploadArquivo('form_update','DBVAR_STR_IMG', 'upload//<%=Request.Cookies("VBOSS")("CLINAME")%>//MB_LIVRO//');"><img src="../img/BtUpload.gif" border="0" style="vertical-align:top; padding-top:2px;" vspace="0" hspace="0"></a>
	</div>
	...
	<div class="form_grupo" id="form_grupo_2">
		...
		<br><div class="form_label">ISBN:</div><input name="DBVAR_STR_ISBN" type="text" style="width:150px;" maxlength="25" value="<%=GetValue(objRS,"ISBN")%>">
	...
	<div class="form_grupo" id="form_grupo_3">
		...
		<br><div class="form_label">Classe:</div><input name="DBVAR_STR_CLASSE" type="text" size="50" maxlength="200" value="<%=GetValue(objRS,"CLASSE")%>">
		<br><div class="form_label">Propriedade:</div><input name="DBVAR_STR_PROPRIEDADE" type="text" size="50" maxlength="200" value="<%=GetValue(objRS,"PROPRIEDADE")%>">
		<br><div class="form_label">Extra:</div><input name="DBVAR_STR_EXTRA" type="text" size="50" maxlength="50" value="<%=GetValue(objRS,"EXTRA")%>">
