...
<%
 ...
 'Verifica se o arquivo é do formato esperado (como não temos outra indicação, testamso o cabeçalho inteiro do mesmo).
 ...
 If ucase(strLine)<>"XLW|GRGFOL|ZFGLIVH|VWRGLIZ|VWRXZL|ZML|XLWYZI|RHYM|OLXZO|KIZAL VNKI|OLXZWL|RWRLNZ|ZJFRHRXZL|XZGVTLIRZ|ZHHFMGL|XOZHHV|ELOFNV|VCGIZ|IVHVMSZ" then
   Mensagem "Formato de arquivo não reconhecido. Poderão ser importados somente arquivos de LIVROS do MiniBiblio (buffer_livros.dbb)", "", 1, True
   response.end
 End If  
