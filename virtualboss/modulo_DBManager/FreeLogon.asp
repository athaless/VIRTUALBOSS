...
If (Request.Form <> "") Then
	Response.Write("<tr><td colspan=""2""><p><span class=""Warning""><img src=""appWarningSmall.gif"" alt=""Warning""> Senha Incorreta</span></p></td></tr>")
End If
Response.Write("<tr><td>")
Response.Write("<span class=""FieldName"">Autorização:</td><td>")
Response.Write("Admin")
Response.Write("</td></tr>")
Response.Write("<tr><td align=""left"" valign=""top""><strong>Senha:</strong></td><td align=""left"" valign=""bottom""><input type=""Password"" name=""adminpassword"" size=""35"" maxlength=""255"" value=""")
