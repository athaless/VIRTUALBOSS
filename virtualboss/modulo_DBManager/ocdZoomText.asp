...
' response.write (strTextField & "<BR>")
' response.Write(strCallingForm & "<BR>")
...
textarea {
	...
	<body onload="javascript:getzoomtext();">
		...
		<a href="#" onclick="javascript:writebacktext()">Atualizar</a>
		<a href="#" onclick="javascript:self.close()">Cancelar</a>
		</center>
	</body>
</html>