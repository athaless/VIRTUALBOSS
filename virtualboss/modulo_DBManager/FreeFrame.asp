...
End If
Response.Write("</frameset><noframes><body>Seu navegador não suporta frames <a href=""Connect.asp"">Clique aqui e escolha a opção Sem Frames para continuar</a>.</body></noframes>")
