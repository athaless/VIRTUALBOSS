	...
	<head>
		...
		<script language="JavaScript" type="text/javascript">
			...
			function submeterForm() {
				...
				if (document.form_insert.DBVAR_STR_PRODUTORô.value == '') var_msg += '\n Banda';
...
<body>
<%=athBeginDialog(WMD_WIDTH, "Dado - Inser&ccedil;&atilde;o") %>
<form name="form_insert" action="../_database/athInsertToDB.asp" method="post">
	...
	<input type="hidden" name="DEFAULT_LOCATION" value='../modulo_MB_DADO/insert.asp'>
	...
	<div class="form_grupo" id="form_grupo_1">
		...
		<br><div class="form_label">*Produtor:</div><input name="DBVAR_STR_PRODUTORô" type="text" style="width:150px;" maxlength="25" value="">
		<br><div class="form_label">Formato:</div><input name="DBVAR_STR_FORMATO" type="text" style="width:150px;" maxlength="200" value="">
		<br><div class="form_label">Mídia:</div><input name="DBVAR_STR_MIDIA" type="text" style="width:70px;" maxlength="10" value="">
		<div class="form_label_nowidth" style="text-align:right;width:55px;">Tamanho:</div><input name="DBVAR_STR_TAMANHO" type="text" style="width:80px;" />
		<br><div class="form_label">*Ano:</div><select name="DBVAR_NUM_ANOô" style="width:60px;"><option value=""></option><% montaComboAno(1700-2050) %></select>
		<br><div class="form_label">Categoria:</div><select name="DBVAR_INT_COD_CATEGORIA" style="width:140px;"><option value="NULL"></option><%=montaCombo("STR","SELECT COD_CATEGORIA, NOME FROM mb_dado_categoria WHERE DT_INATIVO IS NULL","COD_CATEGORIA","NOME","")%></select>
		<br><div class="form_label">Imagem:</div><input name="DBVAR_STR_IMG" type="text" maxlength="250" value="" style="width:200px;"><a href="javascript:UploadArquivo('form_insert','DBVAR_STR_IMG', 'upload//<%=Request.Cookies("VBOSS")("CLINAME")%>//MB_DADO//');"><img src="../img/BtUpload.gif" border="0" style="vertical-align:top; padding-top:2px;" vspace="0" hspace="0"></a>
	</div>
