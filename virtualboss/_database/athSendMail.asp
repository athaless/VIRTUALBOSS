...
Response.CharSet	= "iso-8859-1"
 ...
 ' Por um período pra agilizar o uso do VBOSS estmaso sem envio de EMAILS
 ...
 On Error Resume Next
	  ...
	  'objCDOSYSCon.Fields("http://schemas.microsoft.com/cdo/configuration/sendpassword") = "ath503bbsi319"
	  ...
	  pmFROM = "noreply@proevento.com.br"
	 ...
	 ' objCDOSYSCon.Fields("http://schemas.microsoft.com/cdo/configuration/sendpassword") = "athroute66" 
	  ...
	  objCDOSYSMail.TextBodyPart.Charset = "iso-8859-1"
	  objCDOSYSMail.HTMLBodyPart.Charset = "iso-8859-1"
	  objCDOSYSMail.TextBodyPart.ContentTransferEncoding = "quoted-printable"
	  objCDOSYSMail.HTMLBodyPart.ContentTransferEncoding = "quoted-printable"  
...
Response.CharSet	= "iso-8859-1"
 ...
 'strBODY =	strBODY & "           	</td>" & VbCrLf
  ...
  AthEnviaMail strTO, "noreply@proevento.com.br", "", "ath.virtualboss@gmail.com", strSUBJECT, strBODY, 1, 0, 0, ""
End Function
%>