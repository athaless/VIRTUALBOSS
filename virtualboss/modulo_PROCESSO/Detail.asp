...
%>
 ...
 <tbody style="text-align:left;">
		...
		%>
		<tr>
		  <td width="1%" nowrap><%=MontaLinkGrade("modulo_PROCESSO","delete_proctarefa.asp",GetValue(objRS2, "COD_TAREFA") & "&var_instarefas=" & strINSTAREFAS,"IconAction_DEL.gif","REMOVER")%></td>
		  <td width="1%" nowrap><%=MontaLinkGrade("modulo_PROCESSO","update_proctarefa.asp",GetValue(objRS2, "COD_TAREFA"),"IconAction_EDIT.gif","ALTERAR")%></td>
		  <td width="1%" nowrap><%=GetValue(objRS2, "NUMERO")%></td>
		  <td width="93%"><%=GetValue(objRS2, "DESC_OQUE")%></td>
		  <td width="1%" nowrap><%=GetValue(objRS2, "DESC_QUEM")%></td>
		  <td width="1%" nowrap><%=GetValue(objRS2, "DESC_QUANDO")%></td>
		  <td width="1%" nowrap><%=GetValue(objRS2, "COMPLEMENTAR")%></td>
		  <td width="1%" nowrap>
