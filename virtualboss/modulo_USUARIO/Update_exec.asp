...
<%
	...
	Dim strCOD_USUARIO, strNOME, strSENHA, strEMAIL, strTIPO, strCODIGO, strLOGINFB
	Dim strGRP_USER, strDIR_DEFAULT, strOBS, strFOTO, strDT_INATIVO, strRETORNO, strAPELIDO, strIDUSERMODEL
	...
	strSQL = strSQL & "  ,LOGIN_FACEBOOK = '" & strLOGINFB & "' "	
	strSQL = strSQL & "  ,ID_USUARIO_MODELO = '" & strIDUSERMODEL & "' "	
