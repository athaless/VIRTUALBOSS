...
<% VerificaDireito "|INS|", BuscaDireitosFromDB("modulo_MB_REVISTA", Request.Cookies("VBOSS")("ID_USUARIO")), true %>
	...
	<head>
		...
		<script language="JavaScript" type="text/javascript">
			...
			function submeterForm() {
				...
				if (document.form_insert.DBVAR_STR_CAPAô.value == '') var_msg += '\n Capa';
				if (document.form_insert.DBVAR_STR_EDITORAô.value == '') var_msg += '\n Editora';
				if (document.form_insert.DBVAR_NUM_MESô.value  == '') var_msg += '\n Mês';
...
<body>
<%=athBeginDialog(WMD_WIDTH, "Revista - Inser&ccedil;&atilde;o") %>
<form name="form_insert" action="../_database/athInsertToDB.asp" method="post">
	...
	<input type="hidden" name="DEFAULT_LOCATION" value='../modulo_MB_REVISTA/insert.asp'>
	...
	<div class="form_grupo" id="form_grupo_1">
		...
		<br><div class="form_label">*Nome:</div><input name="DBVAR_STR_NOMEô" type="text" style="width:270px;" maxlength="200" value="">
		<br><div class="form_label">*Capa:</div><input name="DBVAR_STR_CAPAô" type="text" style="width:270px;" maxlength="200" value="">
		...
		<div class="form_label_nowidth" style="text-align:right;width:35px;">*Mês:</div><select name="DBVAR_NUM_MESô" style="width:40px;"><% for auxContador = 1 to 12 %><option value="<%=auxContador%>"><%=auxContador%></option><% next %></select><div class="form_label_nowidth" style="text-align:right;width:35px;">*Ano:</div><select name="DBVAR_NUM_ANOô" style="width:60px;"><option value=""></option><% montaComboAno(1700-2050) %></select>
		...
		<br><div class="form_label">Categoria:</div><select name="DBVAR_INT_COD_CATEGORIA" style="width:140px;"><option value="NULL"></option><%=montaCombo("STR","SELECT COD_CATEGORIA, NOME FROM mb_revista_categoria WHERE DT_INATIVO IS NULL","COD_CATEGORIA","NOME","")%></select>
		...
		<br><div class="form_label">Imagem:</div><input name="DBVAR_STR_IMG" type="text" maxlength="250" value="" style="width:200px;"><a href="javascript:UploadArquivo('form_insert','DBVAR_STR_IMG', 'upload//<%=Request.Cookies("VBOSS")("CLINAME")%>//MB_REVISTA//');"><img src="../img/BtUpload.gif" border="0" style="vertical-align:top; padding-top:2px;" vspace="0" hspace="0"></a>
	</div>
	...
	<div class="form_grupo" id="form_grupo_2">
		...
		<br><div class="form_label">ISSN:</div><input name="DBVAR_STR_ISSN" type="text" style="width:150px;" maxlength="25" value="">	
	...
	<div class="form_grupo" id="form_grupo_3">
		...
		<br><div class="form_label">Periodicidade:</div><input name="DBVAR_STR_PERIODICIDADE" type="text" style="width:150px;" maxlength="200" value="">
		<br><div class="form_label">Localização:</div><input name="DBVAR_STR_LOCALIZACAO" type="text" style="width:150px;" maxlength="20" value="">
		<br><div class="form_label">Propriedade:</div><input name="DBVAR_STR_PROPRIEDADE" type="text" style="width:150px;" maxlength="200" value="">
