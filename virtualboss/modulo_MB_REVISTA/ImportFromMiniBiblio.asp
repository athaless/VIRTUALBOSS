...
<body>
<%=athBeginDialog(WMD_WIDTH, "Revista - Importação (MiniBiblio)") %>
<form name="form_insert" action="ImportFromMiniBiblio_exec.asp" method="post">
	...
	<input type="hidden" name="DEFAULT_LOCATION" value='../modulo_MB_REVISTA/data.asp'>
	...
	<img src="../img/BtUpload.gif" border="0" style="vertical-align:top; padding-top:2px;" vspace="0" hspace="0"></a>&nbsp;<span class="texto_ajuda">(buffer_revistas.dbb)</span>
</form>
