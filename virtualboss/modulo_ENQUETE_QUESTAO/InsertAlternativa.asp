...
<body>
<%=athBeginDialog(WMD_WIDTH, "Alternativa - Inser&ccedil;&atilde;o") %>
<form name="form_insert" action="../_database/athInsertToDB.asp" method="post" >
	...
	<input type="hidden" name="DEFAULT_LOCATION" 		   value='../modulo_ENQUETE_QUESTAO/DetailQuestao.asp?var_chavereg=<%=strCODIGO%>'>    
