...
<% VerificaDireito "|DEL|", BuscaDireitosFromDB("modulo_ENQUETE", Request.Cookies("VBOSS")("ID_USUARIO")), true %>
...
<%
 ...
 Const auxAVISO  = "dlg_warning.gif:ATENÇÃO!Você está prestes a remover o registro <br> acima visualizado. Para confirmar clique no botão [ok], para desistir clique em [cancelar]."
  ...
  If strCODIGO <> "" Then
	  ...
	  strSQL = "SELECT * FROM EN_ENQUETE WHERE COD_ENQUETE = " & strCODIGO 
...
<body>
<%=athBeginDialog(WMD_WIDTH, "Enquete - Dele&ccedil;&atilde;o")%>     
