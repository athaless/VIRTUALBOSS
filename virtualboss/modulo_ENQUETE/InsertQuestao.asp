...
<form name="form_insert" action="../_database/athInsertToDB.asp" method="post">
	...
	<input type="hidden" name="DBVAR_NUM_COD_ENQUETE" value="<%=strCODIGO%>">
    ...
    <br><div class="form_label">Questão:</div><input name="DBVAR_STR_QUESTAO" type="text" maxlength="250" value="" style="width:160px;">
</form>
