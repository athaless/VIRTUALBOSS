...
<%
 ...
 Dim objRSLocal,LocalauxCont,LocalstrSQL
   ...
   LocalstrSQL = LocalstrSQL & "   AND GRP_USER LIKE '" & prgrpusr & "' "
...
<%
	...
	strSQL = strSQL & "    AND (GRP_USER LIKE '" & strGrpUser & "') "
...
<div class='painel_menu_acord'>
<%
		While not ObjRS.EOF
			Response.Write("<div style='float:left;margin-bottom:5px;'><div name='menu_acord' class='titulo_menu_acord'>")
			Response.Write("<span>" & GetValue(ObjRS,"ROTULO") & "</span><img src='../img/arrow_down.gif'></div>")
