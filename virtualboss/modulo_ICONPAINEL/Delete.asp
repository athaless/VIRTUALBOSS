...
<% VerificaDireito "|DEL|", BuscaDireitosFromDB("modulo_ICONPAINEL", Request.Cookies("VBOSS")("ID_USUARIO")), true %>
...
<%
 ...
 If strCODIGO <> "" Then
  ...
  strSQL = "SELECT * FROM SYS_PAINEL WHERE COD_PAINEL = " & strCODIGO
...
<%=athBeginDialog(WMD_WIDTH, "Painel de Controle - Exclus&atilde;o") %>
