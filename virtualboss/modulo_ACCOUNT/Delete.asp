...
<% VerificaDireito "|DEL|", BuscaDireitosFromDB("modulo_ACCOUNT", Request.Cookies("VBOSS")("ID_USUARIO")), true %>
...
<%
 ...
 Const auxAVISO  = "dlg_warning.gif:ATENÇÃO!Você está prestes a remover o registro <br> acima visualizado. Para confirmar clique no botão [ok], para desistir clique em [cancelar]."
   ...
   If strCODIGO <> "" Then
	  ...
	  strSQL = "SELECT * FROM ACCOUNT_SERVICE WHERE COD_ACCOUNT_SERVICE = " & strCODIGO
...
<% for Idx = 0 to objRS.fields.count -5 %> 
