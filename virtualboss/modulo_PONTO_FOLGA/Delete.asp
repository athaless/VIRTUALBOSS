...
<% VerificaDireito "|DEL|", BuscaDireitosFromDB("modulo_PONTO_FOLGA", Request.Cookies("VBOSS")("ID_USUARIO")), true %>
...
<%
 ...
 Const auxAVISO  = "dlg_warning.gif:ATENÇÃO!Você está prestes a remover o registro <br> acima visualizado. Para confirmar clique no botão [ok], para desistir clique em [cancelar]."
   ...
   If strCODIGO <> "" Then
	  ...
	  strSQL = "SELECT * FROM PT_FOLGA WHERE COD_FOLGA = " & strCODIGO 
...
<body>
<%=athBeginDialog(WMD_WIDTH, "Folga - Dele&ccedil;&atilde;o")%>    
