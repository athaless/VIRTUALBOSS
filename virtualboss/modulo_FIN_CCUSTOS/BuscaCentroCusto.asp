...
<%
	strSQL = " SELECT COD_CENTRO_CUSTO, COD_REDUZIDO, NOME, NIVEL, DT_INATIVO FROM FIN_CENTRO_CUSTO ORDER BY COD_REDUZIDO, ORDEM, NOME"
...
%>
	<tr bgcolor="<%=strCOLOR%>" style="cursor:hand;" onMouseOver="this.style.backgroundColor='#FFCC66';" onMouseOut="this.style.backgroundColor='';" onClick="Retorna('<%=GetValue(objRS,"COD_CENTRO_CUSTO")%>','<%=GetValue(objRS,"COD_REDUZIDO")%>');">
		<td></td>
		<td style="text-align:right;"><%=GetValue(objRS,"COD_CENTRO_CUSTO")%></td>
