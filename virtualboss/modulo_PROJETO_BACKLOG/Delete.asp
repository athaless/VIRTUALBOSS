...
<% VerificaDireito "|DEL|", BuscaDireitosFromDB("modulo_PROJETO_BACKLOG", Request.Cookies("VBOSS")("ID_USUARIO")), true %>
...
<body>
<%=athBeginDialog(WMD_WIDTH, "Projeto Backlog - Dele&ccedil;&atilde;o")%>     
...
<form name="form_delete" action="../_database/athDeleteToDB.asp" method="post">
	<input type="hidden" name="DEFAULT_TABLE"    value="PRJ_BACKLOG">
	<input type="hidden" name="DEFAULT_DB"       value="<%=CFG_DB%>">
	<input type="hidden" name="FIELD_PREFIX"     value="DBVAR_">
	<input type="hidden" name="RECORD_KEY_NAME"  value="COD_PRJ_BACKLOG">
