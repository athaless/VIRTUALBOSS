...
<body>
<%=athBeginDialog(WMD_WIDTH, "Música Disco - Inser&ccedil;&atilde;o") %>
<form name="form_insert" action="../_database/athInsertToDB.asp" method="post">
	...
	<input type="hidden" name="DEFAULT_LOCATION" value='../modulo_MB_DISCO/DetailHistorico.asp?var_chavereg=<%=strCODIGO%>'>
	<input type="hidden" name="DBVAR_NUM_COD_DISCO"   value="<%=strCODIGO%>"/>
	<div class="form_label">Cod. Disco:</div><div class="form_bypass"><b><%=strCODIGO%></b></div>
	<br><div class="form_label">*Título:</div><input name="DBVAR_STR_TITULOô" type="text" style="width:270px;" maxlength="200" value="">
	<br><div class="form_label">Autores:</div><input name="DBVAR_STR_AUTORES" type="text" style="width:150px;" maxlength="50" value="">
	<br><div class="form_label">Tempo:</div><input name="DBVAR_STR_TEMPO" type="text" style="width:150px;" maxlength="20" />
</form>
