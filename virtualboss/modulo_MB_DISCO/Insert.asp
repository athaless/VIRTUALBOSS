...
<% VerificaDireito "|INS|", BuscaDireitosFromDB("modulo_MB_DISCO", Request.Cookies("VBOSS")("ID_USUARIO")), true %>
	...
	<head>
		...
		<script language="JavaScript" type="text/javascript">
			...
			function submeterForm() {
				...
				if (document.form_insert.DBVAR_STR_BANDAô.value == '') var_msg += '\n Banda';
...
<body>
<%=athBeginDialog(WMD_WIDTH, "Disco - Inser&ccedil;&atilde;o") %>
<form name="form_insert" action="../_database/athInsertToDB.asp" method="post">
	<input type="hidden" name="DEFAULT_TABLE"    value="MB_DISCO">
	<input type="hidden" name="DEFAULT_DB"       value="<%=CFG_DB%>">
	<input type="hidden" name="FIELD_PREFIX"     value="DBVAR_">
	<input type="hidden" name="RECORD_KEY_NAME"  value="COD_DISCO">
	<input type="hidden" name="JSCRIPT_ACTION"   value='parent.frames["vbTopFrame"].document.form_principal.submit();'>
	<input type="hidden" name="DEFAULT_LOCATION" value='../modulo_MB_DISCO/insert.asp'>
	...
	<div class="form_grupo" id="form_grupo_1">
		...
		<b>Dados do Disco</b><br>
		<br><div class="form_label">*Título:</div><input name="DBVAR_STR_TITULOô" type="text" style="width:270px;" maxlength="200" value="">
		<br><div class="form_label">*Banda:</div><input name="DBVAR_STR_BANDAô" type="text" style="width:270px;" maxlength="200" value="">
		<br><div class="form_label">Estilo:</div><input name="DBVAR_STR_ESTILO" type="text" style="width:250px;" maxlength="200" value="">
		<br><div class="form_label">Produtor:</div><input name="DBVAR_STR_PRODUTOR" type="text" style="width:150px;" maxlength="25" value="">
		<br><div class="form_label">Gravadora:</div><input name="DBVAR_STR_GRAVADORA" type="text" style="width:150px;" maxlength="200" value="">
		<br><div class="form_label">Selo:</div><input name="DBVAR_STR_SELO" type="text" style="width:150px;" maxlength="25" value="">
		<br><div class="form_label">Edição:</div><select name="DBVAR_STR_EDICAO" style="width:50px;"><option value=""></option><% for auxContador = 1 to 50 %><option value="<%=auxContador%>"><%=auxContador%></option><% next %></select>
		...
		<div class="form_label_nowidth" style="text-align:right;width:35px;">Tempo:</div><input name="DBVAR_STR_TEMPO" type="text" style="width:80px;" />
		<br><div class="form_label">Mídia:</div><input name="DBVAR_STR_MIDIA" type="text" style="width:70px;" maxlength="10" value="">
		<br><div class="form_label">Categoria:</div><select name="DBVAR_INT_COD_CATEGORIA" style="width:140px;"><option value="NULL"></option><%=montaCombo("STR","SELECT COD_CATEGORIA, NOME FROM mb_disco_categoria WHERE DT_INATIVO IS NULL","COD_CATEGORIA","NOME","")%></select>
		...
		<br><div class="form_label">Imagem:</div><input name="DBVAR_STR_IMG" type="text" maxlength="250" value="" style="width:200px;"><a href="javascript:UploadArquivo('form_insert','DBVAR_STR_IMG', 'upload//<%=Request.Cookies("VBOSS")("CLINAME")%>//MB_DISCO//');"><img src="../img/BtUpload.gif" border="0" style="vertical-align:top; padding-top:2px;" vspace="0" hspace="0"></a>
	</div>
	...
	<div class="form_grupo" id="form_grupo_3">
		...
		<br><div class="form_label">Propriedade:</div><input name="DBVAR_STR_PROPRIEDADE" type="text" style="width:100px;" maxlength="250" value="">
		<br><div class="form_label">Obs:</div><textarea name="DBVAR_STR_OBS" style="width:270px;height:100px;"></textarea>
