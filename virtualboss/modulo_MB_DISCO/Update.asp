...
<%
	...
	if strCODIGO <> "" then 
		strSQL =          " SELECT * FROM "
		strSQL = strSQL & " mb_disco "
		strSQL = strSQL & " WHERE COD_DISCO = " & strCODIGO
	...
	<head>
		...
		<script language="javascript" type="text/javascript">
			...
			function submeterForm() {
				...
				if (document.form_update.DBVAR_STR_BANDAô.value == '') var_msg += '\n Banda';
...
<body>
<%=athBeginDialog(WMD_WIDTH, "Disco - Altera&ccedil;&atilde;o") %>
<form name="form_update" action="../_database/athUpdateToDB.asp" method="post">
	...
	<input type="hidden" name="DEFAULT_LOCATION" value="../modulo_MB_DISCO/Update.asp?var_chavereg=<%=strCODIGO%>">
	...
	<div class="form_grupo" id="form_grupo_1">
		...
		<br><div class="form_label">*Banda:</div><input name="DBVAR_STR_BANDAô" type="text" style="width:270px;" maxlength="200" value="<%=GetValue(objRS,"BANDA")%>">
		<br><div class="form_label">Estilo:</div><input name="DBVAR_STR_ESTILO" type="text" style="width:250px;" maxlength="200" value="<%=GetValue(objRS,"ESTILO")%>">
		<br><div class="form_label">Produtor:</div><input name="DBVAR_STR_PRODUTOR" type="text" style="width:150px;" maxlength="25" value="<%=GetValue(objRS,"PRODUTOR")%>" />
		<br><div class="form_label">Gravadora:</div><input name="DBVAR_STR_GRAVADORA" type="text" style="width:150px;" maxlength="200" value="<%=GetValue(objRS,"GRAVADORA")%>">
		<br><div class="form_label">Selo:</div><input name="DBVAR_STR_SELO" type="text" style="width:150px;" maxlength="25" value="<%=GetValue(objRS,"SELO")%>">
		...
		<div class="form_label_nowidth" style="text-align:right;width:35px;">Tempo:</div><input name="DBVAR_STR_TEMPO" type="text" style="width:80px;" maxlength="10" value="<%=GetValue(objRS,"TEMPO")%>" />
		...
		<br><div class="form_label">Categoria:</div><select name="DBVAR_INT_COD_CATEGORIA" style="width:140px;"><option value="NULL"></option><%=montaCombo("STR","SELECT COD_CATEGORIA, NOME FROM mb_disco_categoria WHERE DT_INATIVO IS NULL","COD_CATEGORIA","NOME",GetValue(objRS,"COD_CATEGORIA"))%></select>
		...
		<br><div class="form_label">Imagem:</div><input name="DBVAR_STR_IMG" type="text" maxlength="250" value="<%=GetValue(objRS,"IMG")%>" style="width:200px;"><a href="javascript:UploadArquivo('form_update','DBVAR_STR_IMG', 'upload//<%=Request.Cookies("VBOSS")("CLINAME")%>//MB_DISCO//');"><img src="../img/BtUpload.gif" border="0" style="vertical-align:top; padding-top:2px;" vspace="0" hspace="0"></a>
	</div>
	...
	<div class="form_grupo" id="form_grupo_3">
		...
		<br><div class="form_label">Propriedade:</div><input name="DBVAR_STR_PROPRIEDADE" type="text" style="width:200px;" maxlength="250" value="<%=GetValue(objRS,"PROPRIEDADE")%>">
